...
public class RegionMenuData {
    ...
    public static Inventory getGridWorldGuardMenu(Player player) {
        ...
        ItemStack menuicon1 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 14,
        ...
        ItemStack menuicon3 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 10,
        ...
        ItemStack menuicon4 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 11, ChatColor.DARK_GREEN + "設定",
        ...
        ItemStack menuicon5 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 5,
        ...
        ItemStack menuicon6 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 4, ChatColor.RED + "全設定リセット",
        ...
        ItemStack menuicon7 = MenuIcon.getMenuIcon(Material.LEGACY_STAINED_GLASS_PANE, 1, 13,
